...
public class ProxyResourceLister implements ExternalResourceLister {
    private ProxyResourceAccessor accessor;

    public ProxyResourceLister(ProxyResourceAccessor accessor) {
